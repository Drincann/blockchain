...
describe('Block', () => {
  it('genesis block', () => {
    ...
    assert.equal(hex(genesisBlock.hash()), '6038f6308a3437930d464efa8090837b8bc2710196e05d373fcb741cdc0a7534')
  ...
  it('serialize/deserialize', () => {
    ...
    assert.equal(hex(deserialized.data), hex(genesisBlock.data))
  })
})
