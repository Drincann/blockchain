...
class UnspentTransactionOut {
  ...
  constructor({ blockhash, txid, index, output }: { blockhash: string, txid: string; index: number; output: Output }) {
  ...
  public static fromTransaction(blockhash: Uint8Array, tx: Transaction): UnspentTransactionOut[] {
